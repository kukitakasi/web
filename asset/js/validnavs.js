...
(function($) {
    ...
    $(".onepage-menu ul.nav>li>a").click(function(){
    ...
    $('.nav-items .smooth-menu').on('click', function(event) {
        var $anchor = $(this);
        var headerH = '0';
        $('html, body').stop().animate({
            scrollTop: $($anchor.attr('href')).offset().top - headerH + "px"
...
(function($) {
	$.fn.simpleMenu = function(options) {
		"use strict";
		var $a = $(this),
			$b = $(this).find('.nav-item .dropdown-toggle').next();
		$a.on('click', '.nav-item .dropdown-toggle', function(e) {
				e.stopPropagation();
